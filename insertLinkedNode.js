...
function insertNodeAtPosition(head, data, position) {
    console.log(head.next, head.data)
    //let dummy = null
    //dummy.next = head;
    let dummy = head
    console.log('d', data)
    console.log('dummy', dummy)
    //find the next in the node before position.
    //store this, change the next to the new node
    let next = dummy;
    ...
    newnode.next = next 
    dummy.next = newnode
    console.log('nexty', next)
    console.log('dafter', dummy)
    return head
}
